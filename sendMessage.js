...
function tickCooldown() {
  ...
  if (remaining <= 0) {
    ...
    if (sendCooldownText) sendCooldownText.textContent = "You can send another letter now.";
  ...
  if (sendCooldownText) sendCooldownText.textContent = `You can send another letter in ${remaining}s.`;
