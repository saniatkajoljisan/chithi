...
// URL format: /user?u=username (also supports /user.html?u=username)
...
btnSend?.addEventListener("click", async () => {
  ...
  try {
    ...
    // Build delete URL
    const deleteUrl = window.ChithiUrl?.page("delete", `?token=${deleteToken}`)
      || `${window.location.origin}/delete.html?token=${deleteToken}`;
