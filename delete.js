...
const reactionNameEl  = document.getElementById("reaction-name");
...
const REACTION_LABEL = { heart: "Loved it", smile: "Smiled", cry: "Cried", spark: "Got angry" };
...
function renderReaction(msg) {
  ...
  reactionNameEl.textContent  = REACTION_LABEL[rKey] || rKey;
